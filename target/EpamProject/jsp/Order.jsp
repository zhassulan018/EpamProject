...
<div class="container">
    ...
    <div class="shopping-cart">
        ...
        <div class="column-labels">
            ...
            <label class="product-price"><fmt:message key="label.order.price"/></label>
            <label class="product-quantity"><fmt:message key="label.order.quantity"/></label>
            <label class="product-removal"><fmt:message key="label.order.remove"/></label>
        </div>

        <%
            List basketItems = (List) request.getAttribute("orderItems");
            ...
            <form action="/orders" method="post">
                <div class="product-removal">
                    ...
                    <button class="remove-product" type="submit" name="operation" value="Remove">
                        <fmt:message key="label.order.remove"/>
                    </button>
                </div>
            </form>
